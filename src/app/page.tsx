...
export default function Home() {
  ...
  const renderParticles = () => {
    return Array.from({ length: 20 }).map((_, index) => {
      ...
      const randomColor = `rgba(${Math.random() * 255}, ${Math.random() * 255}, ${Math.random() * 255}, 0.15)`;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-indigo-900 via-purple-900 to-pink-800 text-white overflow-hidden">
      ...
      <header ref={headerRef} className="sticky top-0 z-50 w-full backdrop-blur-md bg-white/10 border-b border-white/20 shadow-lg">
      ...
      {/* Hero Section */}
      <main ref={heroRef} className="flex flex-col items-center justify-center flex-1 text-center px-4 py-20 md:py-32 relative">
        {/* 3D Rotating Element */}
        <div className="absolute right-10 top-10 md:right-32 md:top-32 hidden md:block">
          <div
            ref={cubeRef}
            className="cube w-32 h-32 relative"
          >
        ...
        <FadeInSection className="w-full">
          <h1
            className="hero-title text-5xl md:text-7xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-pink-400"
          >
        ...
        <FadeInSection delay={0.2} className="w-full">
          <p
            className="hero-description text-xl md:text-2xl max-w-2xl mx-auto mb-10 text-gray-200"
          >
        ...
        <FadeInSection delay={0.4} className="w-full max-w-3xl">
          ...
          >
            ...
            <div className="mt-4 overflow-hidden transition-all">
              ...
              <div id="advanced-filters" className="h-0 overflow-hidden transition-all duration-300">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  <div className="text-sm text-gray-300 mr-2 mt-1">Popular Skills:</div>
                  {["React", "Java", "Python", "TypeScript", "AWS", "UI/UX", "Node.js"].map((skill) => (
                    <button
                      key={skill}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-3xl">
          {[
            ...
            >
              <div
                className="stat-card bg-white/10 backdrop-blur-md p-4 rounded-xl border border-white/20 hover:bg-white/15 transition-all hover:scale-105"
              >
                <p
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div
                  className="feature-card bg-white/5 backdrop-blur-md p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-all hover:shadow-xl group h-full relative hover:-translate-y-2"
                >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-3 flex flex-wrap gap-3 justify-center mb-8">
            {[
              ...
              <button
                key={filter.id}
                className={`py-2 px-4 rounded-full transition-all ${activeFilter === filter.id
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <div
                  className="job-card bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden hover:shadow-2xl transition-all group relative hover:-translate-y-2"
                >
                  {/* Glowing effect on hover */}
                  ...
                  <div className="p-6 relative z-10">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {job.skills.map((skill, idx) => (
                        <span
                          key={idx}
                          className={`skill-tag bg-white/5 text-sm py-1 px-3 rounded-full border border-white/5 group-hover:border-${job.color.split('-')[2]}-400/30 transition-colors hover:scale-110 hover:bg-white/15 transition-all`}
                        >
                          {skill}
                        </span>
                      ))}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div
                  className={`testimonial-card bg-white/5 backdrop-blur-md p-8 rounded-2xl border border-white/10 relative h-full group float-animation-${index + 1}`}
                >
                  <div
                  ...
                  <div className="flex items-center">
                    {testimonial.avatar ? (
                      <div
                        className="w-12 h-12 rounded-full mr-4 overflow-hidden border-2 border-white/20 group-hover:border-white/40 transition-colors hover:scale-110 hover:rotate-6 transition-transform"
                      >
                        <Image
      ...
      <section className="py-20 bg-gradient-to-b from-pink-950 to-indigo-900 relative overflow-hidden">
        ...
        <div className="floating-shapes absolute inset-0 pointer-events-none">
          {Array.from({ length: 6 }).map((_, index) => (
            <div
              key={index}
              className={`floating-shape absolute rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 float-animation-${index % 3 + 1}`}
              style={{
        ...
        <div className="container mx-auto px-4">
          <FadeInSection className="w-full">
            <div
              className="cta-card bg-gradient-to-r from-blue-900/50 to-purple-900/50 backdrop-blur-md border border-white/10 p-8 md:p-12 rounded-3xl text-center max-w-4xl mx-auto relative overflow-hidden hover:shadow-2xl transition-shadow"
            >
              {/* Dynamic Background */}
              <div className="absolute inset-0 overflow-hidden opacity-30">
                ...
                ></div>
                <div
                  className="absolute -top-40 -right-40 w-80 h-80 bg-blue-500 rounded-full mix-blend-screen filter blur-3xl blob-animation-1"
                ></div>
                <div
                  className="absolute -bottom-40 -left-40 w-80 h-80 bg-purple-500 rounded-full mix-blend-screen filter blur-3xl blob-animation-2"
                ></div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                <button
                  className="cta-btn-primary bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-semibold px-8 py-4 rounded-xl shadow-lg transition-all relative overflow-hidden group hover:scale-105 active:scale-95"
                >
                  <span className="relative z-10">Create Your Profile</span>
                  <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-cyan-400 to-blue-600 opacity-0 group-hover:opacity-100 blur-xl transition-opacity" />
                </button>
                <button
                  className="cta-btn-secondary bg-white/10 hover:bg-white/20 border border-white/20 font-semibold px-8 py-4 rounded-xl transition-all hover:scale-105 active:scale-95"
                >
                  Browse Jobs
                </button>
              </div>
      ...
      <section className="py-20 bg-gradient-to-b from-purple-950 to-pink-950 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="grid grid-cols-12 grid-rows-6 h-full">
            {Array.from({ length: 24 }).map((_, index) => (
              <div key={index} className="border-b border-r border-white/5"></div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <FadeInSection delay={0.2} className="w-full">
            <p className="text-xl text-center max-w-2xl mx-auto mb-16 text-gray-300">
              Track your job applications, get personalized recommendations, and manage your career progress all in one place.
            </p>
          </FadeInSection>
                    ...
                    <div className="flex flex-col h-full">
                      ...
                      <nav className="space-y-1 flex-grow">
                        {[
                          ...
                          { label: 'Applications', active: false, icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
                          ...
                          <a
                            key={item.label}
                            href="#"
                            className={`flex items-center px-4 py-3 rounded-xl transition-colors ${item.active
                  ...
                  <div className="col-span-12 md:col-span-9 lg:col-span-10 p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                      {[
                        ...
                        { label: 'Interview Invites', value: '3', change: '+1' }
                      ].map((stat) => (
                    ...
                    <div className="bg-white/5 rounded-xl p-6 border border-white/10 mb-8">
                      ...
                      <div className="space-y-4">
                        {[
                          { company: 'Microsoft', role: 'Senior Frontend Developer', status: 'In Review' },
                          { company: 'Amazon', role: 'Data Scientist', status: 'Interview Scheduled' },
                          { company: 'Google', role: 'Product Manager', status: 'Application Sent' }
                        ].map((app) => (
                          <div key={app.role} className="flex items-center justify-between py-3 border-b border-white/10 last:border-0">
                            <div>
                              <p className="font-medium">{app.role}</p>
                              <p className="text-sm text-gray-400">{app.company}</p>
                            </div>
                            <span className="px-3 py-1 rounded-full text-sm bg-white/10">{app.status}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                      <h4 className="text-lg font-semibold mb-4">Recommended Jobs</h4>
                      <div className="space-y-4">
                        {[
                          { title: 'Full Stack Developer', company: 'TechCorp', match: '95%' },
                          { title: 'UI/UX Designer', company: 'DesignHub', match: '92%' },
                          { title: 'DevOps Engineer', company: 'CloudTech', match: '88%' }
                        ].map((job) => (
                          <div key={job.title} className="flex items-center justify-between py-3 border-b border-white/10 last:border-0">
                            <div>
                              <p className="font-medium">{job.title}</p>
                              <p className="text-sm text-gray-400">{job.company}</p>
                            </div>
                            <div className="text-right">
                              <span className="text-green-400 text-sm">{job.match} Match</span>
        ...
        <div className="container mx-auto px-4 py-16 relative">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <FadeInSection delay={0.2} className="space-y-4">
              ...
              <p className="text-gray-400">
                Your trusted partner in finding the perfect career opportunity. Connect with top employers and advance your professional journey.
              </p>
          ...
          <FadeInSection delay={0.6} className="mt-16">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-400 mb-6">Subscribe to our newsletter for the latest job opportunities and career tips.</p>
          ...
          {/* Bottom Bar */}
          <FadeInSection delay={0.7} className="mt-16 pt-8 border-t border-white/10">
      ...
      <div
        ref={backToTopRef}
        className={`fixed right-6 bottom-6 z-50 transition-transform duration-300 ${showBackToTop ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}
      >
        <button
          onClick={scrollToTop}
